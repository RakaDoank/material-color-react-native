...
This is a directory where the `material-color-react-native` code actually lives and published to the npm registry. Go to the [project root](https://github.com/RakaDoank/material-color-react-native) instead
