...
Material Color React Native is a library to bring material color utilities from the [`@material-foundation/material-color-utilities`](https://github.com/material-foundation/material-color-utilities), including material color builder from an image, and special [Android Dynamic Color](https://developer.android.com/develop/ui/views/theming/dynamic-colors).
